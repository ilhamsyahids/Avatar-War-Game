...
//        CONST & TYPEDEF        //
///////////////////////////////////
const int ArrayIdxMin = 1;
/* Indeks minimum array */

const int ArrayIdxUndef = -999;
...
//        SELECTOR GET      //
//////////////////////////////
ArrayElType* ArrayGetTab(Array T);
/* Mengirimkan T.TI */

ArrayElType ArrayGetTabElement(Array T, ArrayIdxType i);
/* Mengirimkan (T).TI[(i)] */

int ArrayGetMaxElement(Array T);
/* Mengirimkan nilai MaxElement dari Explicit Array */

int ArrayGetNeff(TabInt T);
...
//        SELECTOR SET      //
//////////////////////////////
void ArraySetTab(Array *T);
/* Mengirimkan T.TI */

void ArraySetTabElement(Array *T, ArrayIdxType i);
/* Mengirimkan (T).TI[(i)] */

void ArraySetMaxElement(Array *T);
/* Mengirimkan nilai MaxElement dari Explicit Array */

void ArraySetNeff(TabInt *T);
/* Mengirimkan banyaknya elemen efektif tabel */
/* Mengirimkan nol jika tabel kosong */
